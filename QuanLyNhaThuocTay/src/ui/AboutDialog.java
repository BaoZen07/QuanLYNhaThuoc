...
public class AboutDialog extends JDialog {
	...
	public AboutDialog(MainFrame frame) {
		...
		JLabel lbIcon = new JLabel(new ImageIcon("Images/icon_big.png"));
		lbIcon.setOpaque(false);
		lbIcon.setVerticalAlignment(JLabel.TOP);
		
		JLabel lbPhealis = new JLabel("Phealis");
		lbPhealis.setFont(new Font("Forte", Font.BOLD, 42));
		
		JLabel lbName = new JLabel("Ứng dụng quản lý nhà thuốc");
		JLabel lbVersion = new JLabel("Phiên bản 1.0");
		JLabel lbMember = new JLabel("Các thành viên thực hiện:");
		JLabel lbMember1 = new JLabel("Điểu Long");
		JLabel lbMember2 = new JLabel("Vũ Đình Khánh Đăng");
		JLabel lbMember3 = new JLabel("Hoàng Xuân Khang");
		JLabel lbMember4 = new JLabel("Nguyễn Trung Hải");
		...
		lbMember4.setFont(UIConstant.NORMAL_FONT);
		...
		Box boxMember4 = Box.createHorizontalBox();
		boxMember4.add(Box.createHorizontalGlue());
		boxMember4.add(lbMember4);
		boxMember4.add(Box.createHorizontalGlue());
		...
		btnDong = new ColoredButton("Đóng", new ImageIcon("Images/back.png"));
