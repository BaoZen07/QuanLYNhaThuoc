...
public class PrintPreview extends JDialog {
	...
	public PrintPreview(JDialog owner, HoaDon hoaDon) {
		super(owner);
		...
		setIconImage(new ImageIcon("Images/print.png").getImage());
		...
		btnIn = new ColoredButton("In", new ImageIcon("Images/print.png"));
		...
		addNewLine(pnlMain, "", "QUẦY THUỐC TÂY PHEALIS", true, true);
		addNewLine(pnlMain, "", "Phường X, quận Y, Thành phố Z", true, false);
		pnlMain.add(Box.createVerticalStrut(20));
		...
		JTextArea txtThuocTitle = new JTextArea("Tên thuốc");
		txtThuocTitle.setFont(new Font("Times new roman", Font.PLAIN, 16));
		txtThuocTitle.setMaximumSize(new Dimension(150, 50));
		txtThuocTitle.setMinimumSize(new Dimension(150, 50));
		txtThuocTitle.setLineWrap(true);
		txtThuocTitle.setWrapStyleWord(true);
		txtThuocTitle.setEditable(false);

		JTextArea txtDVTTitle = new JTextArea("Đơn vị tính");
		txtDVTTitle.setFont(new Font("Times new roman", Font.PLAIN, 16));
		txtDVTTitle.setMaximumSize(new Dimension(150, 50));
		txtDVTTitle.setMinimumSize(new Dimension(150, 50));
		txtDVTTitle.setLineWrap(true);
		txtDVTTitle.setWrapStyleWord(true);
		txtDVTTitle.setEditable(false);
		...
		lbDGTitle.setPreferredSize(new Dimension(100, 20));
		...
		lbTTTitle.setPreferredSize(new Dimension(100, 20));
		...
		boxTitle.add(txtThuocTitle);
		boxTitle.add(Box.createHorizontalStrut(5));
		boxTitle.add(txtDVTTitle);
		boxTitle.add(Box.createHorizontalStrut(5));
		...
		for(CTHoaDon item : ds) {
			JLabel lbSTT = new JLabel(ds.indexOf(item) + "");
			lbSTT.setPreferredSize(lbSTTTitle.getPreferredSize());
			lbSTT.setFont(new Font("Times new roman", Font.PLAIN, 16));
			
			JTextArea txtThuoc = new JTextArea(item.getThuoc().getTenThuoc());
			txtThuoc.setFont(new Font("Times new roman", Font.PLAIN, 16));
			txtThuoc.setMaximumSize(txtThuocTitle.getMaximumSize());
			txtThuoc.setMinimumSize(txtThuocTitle.getMinimumSize());
			txtThuoc.setLineWrap(true);
			txtThuoc.setWrapStyleWord(true);
			txtThuoc.setEditable(false);

			JTextArea txtDVT = new JTextArea(item.getDonViTinh());
			txtDVT.setFont(new Font("Times new roman", Font.PLAIN, 16));
			txtDVT.setMaximumSize(new Dimension(150, 50));
			txtDVT.setMinimumSize(new Dimension(150, 50));
			txtDVT.setLineWrap(true);
			txtDVT.setWrapStyleWord(true);
		...
		addNewLine(pnlMain, "Tổng tiền: ", nf.format(new HoaDonDAO().tinhTongTien(hoaDon)) + " VND", false, false);
		pnlMain.add(Box.createVerticalStrut(20));
