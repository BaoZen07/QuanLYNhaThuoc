...
public class UIConstant {
	public static final Color PRIMARY_COLOR = new Color(0x5d69e1);
	public static final Color DANGER_COLOR = new Color(0xE91940);
	...
	public static void showInfo(Component component, String info) {
		JOptionPane.showMessageDialog(component, info, "Thông báo", JOptionPane.INFORMATION_MESSAGE, new ImageIcon("Images/info.png"));
	}
	public static void showWarning(Component component, String warning) {
		JOptionPane.showMessageDialog(component, warning, "Cảnh báo", JOptionPane.WARNING_MESSAGE, new ImageIcon("Images/warning.png"));
	}
	public static void showError(Component component, String error) {
		JOptionPane.showMessageDialog(component, error, "Lỗi", JOptionPane.ERROR_MESSAGE, new ImageIcon("Images/error.png"));
	}
}
