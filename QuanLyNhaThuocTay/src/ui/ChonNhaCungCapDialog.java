...
public class ChonNhaCungCapDialog extends JDialog {
	/**
	 * 
	 */
	...
	public ChonNhaCungCapDialog(QuanLyThuocPanel owner) {
		...
		lbMa.setFont(UIConstant.NORMAL_FONT);
		...
		lbMa.setPreferredSize(new Dimension(120, 20));
		...
		btnTimKiem = new ColoredButton("Tìm", new ImageIcon("Images/search.png"));
		...
		btnQuayLai.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {	
				if(nhaCungCap == null)
					owner.setNhaCungCapDaChon(null);
		...
		btnTimKiem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				nhaCungCaps = nhaCungCapDAO.findNhaCungCap(txtTenNCC.getText().trim(), txtDiaChi.getText().trim(), txtSoFax.getText().trim());
