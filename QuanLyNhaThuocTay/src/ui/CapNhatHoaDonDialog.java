...
public class CapNhatHoaDonDialog extends JDialog {
	...
	private ColoredButton btnThemThuoc;
	...
	private DefaultComboBoxModel<String> loaiHDModel;
	private JComboBox<String> cbbLoaiHD;
	private JTextField txtMaThuoc;
	private JTextField txtTenThuoc;
	protected ChonThuocDialog chonThuocDialog;
	...
	public CapNhatHoaDonDialog(Container owner) {
		...
		setIconImage(new ImageIcon("Images/order.png").getImage());
	...
	public void setHoaDon(HoaDon hoaDon) {
		...
		for(CTHoaDon item : dsCTHD) {
			...
			modelCTHD.addRow(new Object[] {
					item.getThuoc().getTenThuoc(), item.getDonViTinh(), 
	...
	private void addCenter(JPanel pnlCenter) {
		...
		lbMaThuoc.setPreferredSize(new Dimension(70, 20)); lbMaThuoc.setFont(UIConstant.NORMAL_FONT);
		lbTenThuoc.setPreferredSize(new Dimension(70, 20)); lbTenThuoc.setFont(UIConstant.NORMAL_FONT);
		lbSL.setPreferredSize(new Dimension(70, 20)); lbSL.setFont(UIConstant.NORMAL_FONT);
		lbDG.setPreferredSize(new Dimension(70, 20)); lbDG.setFont(UIConstant.NORMAL_FONT);
		lbDV.setPreferredSize(new Dimension(70, 20)); lbDV.setFont(UIConstant.NORMAL_FONT);

		txtMaThuoc = new JTextField(); txtMaThuoc.setEnabled(false);
		txtTenThuoc = new JTextField(); txtTenThuoc.setEnabled(false);
		txtSoLuong = new JTextField();
		txtDonGia = new JTextField();
		txtDVT = new JTextField(); txtDVT.setEnabled(false);

		btnThemThuoc = new ColoredButton("Thêm thuốc vào hóa đơn", new ImageIcon("Images/add.png"));
		btnThemThuoc.setBackground(UIConstant.PRIMARY_COLOR);
		btnThemThuoc.setToolTipText("Thêm một chi tiết mới vào hóa đơn");
		...
		Box boxMaTenThuoc = Box.createHorizontalBox();
		Box boxDVSLDG = Box.createHorizontalBox();

		pnlLeft.add(Box.createVerticalStrut(5));
		pnlLeft.add(boxMaTenThuoc);
		pnlLeft.add(Box.createVerticalStrut(5));
		pnlLeft.add(boxDVSLDG);
		pnlLeft.add(Box.createVerticalStrut(5));

		boxMaTenThuoc.add(Box.createHorizontalStrut(5));
		boxMaTenThuoc.add(lbMaThuoc);
		boxMaTenThuoc.add(txtMaThuoc);
		boxMaTenThuoc.add(Box.createHorizontalStrut(5));
		boxMaTenThuoc.add(lbTenThuoc);
		boxMaTenThuoc.add(txtTenThuoc);
		boxMaTenThuoc.add(Box.createHorizontalStrut(5));

		boxDVSLDG.add(Box.createHorizontalStrut(5));
		boxDVSLDG.add(lbDV);
		boxDVSLDG.add(txtDVT);
		boxDVSLDG.add(Box.createHorizontalStrut(5));
		boxDVSLDG.add(lbSL);
		...
		tableCTHD.setModel(modelCTHD = new DefaultTableModel(new String[] {"Thuốc", "Đơn vị tính", "Số lượng", "Đơn giá", "Thành tiền"}, 0));
		...
		btnXoaCTHD = new ColoredButton("Xoá chi tiết", new ImageIcon("Images/delete.png"));
		btnXoaCTHD.setBackground(UIConstant.DANGER_COLOR);
		btnXoaCTHD.setToolTipText("Xoá chi tiết hóa đơn đã chọn trong bảng");

		btnSuaCTHD = new ColoredButton("Sửa chi tiết", new ImageIcon("Images/modify.png"));
	...
	private void addEast(JPanel pnlEast) {
		...
		lbEmail.setPreferredSize(new Dimension(100, 20)); lbEmail.setFont(UIConstant.NORMAL_FONT);
		lbSDT.setPreferredSize(new Dimension(100, 20)); lbSDT.setFont(UIConstant.NORMAL_FONT);

		txtMaKhachHang = new JTextField(); txtMaKhachHang.setEnabled(false);
		txtTenKhachHang = new JTextField(); txtTenKhachHang.setEnabled(false);
		txtGioiTinh = new JTextField(); txtGioiTinh.setEnabled(false);
		txtDC = new JTextField(); txtDC.setEnabled(false);
		txtEmail = new JTextField(); txtEmail.setEnabled(false);
		txtSDT = new JTextField(); txtSDT.setEnabled(false);

		btnChonKhachHang = new ColoredButton("Chọn khách hàng", new ImageIcon("Images/add.png"));
		btnChonKhachHang.setBackground(UIConstant.PRIMARY_COLOR);

		btnIn = new ColoredButton("In hóa đơn", new ImageIcon("Images/export_white.png"));
		btnIn.setBackground(UIConstant.WARNING_COLOR);
		btnIn.setEnabled(false);

		btnLuu = new ColoredButton("Lưu hóa đơn", new ImageIcon("Images/add.png"));
	...
	private void addNorth(JPanel pnlNorth) {		
		...
		JLabel lbLoaiHD = new JLabel("Loại hóa đơn");
		JLabel lbMaHD = new JLabel("Mã hóa đơn");

		lbLoaiHD.setPreferredSize(new Dimension(100, 20)); lbLoaiHD.setFont(UIConstant.NORMAL_FONT);
		...
		cbbLoaiHD = new JComboBox<String>(loaiHDModel = new DefaultComboBoxModel<String>());
		loaiHDModel.addElement("Bán theo đơn");
		loaiHDModel.addElement("Bán không theo đơn");
	...
	private void addEvent() {
		...
		btnThemThuoc.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				if(chonThuocDialog == null)
					chonThuocDialog = new ChonThuocDialog(CapNhatHoaDonDialog.this);

				chonThuocDialog.setVisible(true);
			}
		});
		...
		cbbLoaiHD.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent e) {
				if(cbbLoaiHD.getSelectedIndex() == 0) {
					btnChonKhachHang.setEnabled(true);
					btnChonKhachHang.setBackground(UIConstant.PRIMARY_COLOR);
				}
				else {
					btnChonKhachHang.setEnabled(false);
					btnChonKhachHang.setBackground(UIConstant.DISABLE_COLOR);
		...
		btnLuu.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(dsCTHD == null || dsCTHD.size() == 0) {
					UIConstant.showWarning(CapNhatHoaDonDialog.this, "Không có thuốc nào trong hóa đơn!");
					return;
				}

				if(cbbLoaiHD.getSelectedIndex() == 0 && khachHang == null) {
					UIConstant.showWarning(CapNhatHoaDonDialog.this, "Chưa chọn khách hàng!");
					return;
				}
		...
		btnSuaCTHD.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int slTon = dsCTHD.get(row).getThuoc().kiemTraSoLuong(sl);
		...
		tableCTHD.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent e) {
				...
				txtMaThuoc.setText(dsCTHD.get(row).getThuoc().getMaThuoc());
				txtTenThuoc.setText(dsCTHD.get(row).getThuoc().getTenThuoc());
				txtDVT.setText(dsCTHD.get(row).getThuoc().getDonViTinh());
		...
		btnXoaCTHD.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(row == -1) {
					UIConstant.showWarning(CapNhatHoaDonDialog.this, "Chưa chọn chi tiết cần xoá!");
					return;
				}
	...
	public void themChiTietHD(Thuoc thuoc, int soLuong, double donGia) {
		if(dsCTHD == null)
		...
		modelCTHD.addRow(new Object[] {
				thuoc.getTenThuoc(), thuoc.getDonViTinh(), soLuong, donGia, soLuong * donGia
		});
	}
