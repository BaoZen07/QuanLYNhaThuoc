...
public class FlashScreen extends JFrame {
	...
	private void addControls() {
		...
		JLabel lblIcon = new JLabel(new ImageIcon("Images/icon_big.png"));
		...
		JLabel lblIn4 = new JLabel("Ứng dụng quản lý nhà thuôc tây Phealis");
		lblIn4.setFont(new Font("Times new roman", Font.BOLD, 24));
		lblIn4.setForeground(new Color(0x09791E));
		...
		progressBar.setForeground(new Color(0x09791E));
